...
public class ProductController {
	...
	public ResponseEntity<ApiResponse> getProductByBrandAndName(@RequestParam String barndName, @RequestParam String productName)
	{
		
		
		
		try {
			List<Product>  products=productService.getProductsByBrandAndName(barndName, productName);
